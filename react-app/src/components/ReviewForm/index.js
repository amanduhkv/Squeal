    ...
    <div className='reviewform-page-container'>
        ...
        <div className='new-review-container'>
          <div className='new-review-inner'>
            <h1 className='new-review-title'>Sample Business Title</h1>
            <form className='new-review-form'>
              ...
              <div className='new-review-stars'>
                        ...
                        {/* SECOND STAR */}
                        <svg ref={hover2} id={isHover2 ? 'two' : isHover3 ? 'three' : isHover4 ? 'four' : isHover5 ? 'five' : ''}
                        ...
                        {/* THIRD STAR */}
                        <svg ref={hover3} id={isHover3 ? 'three' : isHover4 ? 'four' : isHover5 ? 'five' : ''} onClick={() => setRevRate(3)}
                        ...
                        {/* FOURTH STAR */}
                        <svg ref={hover4} id={isHover4 ? 'four' : isHover5 ? 'five' : ''} onClick={() => setRevRate(4)}
                        ...
                        {/* FIFTH STAR */}
                        <svg ref={hover5} id={isHover5 ? 'five' : ''} onClick={() => setRevRate(5)}
